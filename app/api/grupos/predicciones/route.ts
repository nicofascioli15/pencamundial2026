...
export async function POST(req: NextRequest) {
  ...
  const { grupoId, partidoId, local, visitante, aplicarATodos } = await req.json();
  ...
  // Si aplicarATodos=true, actualiza/pisa todos los grupos.
  // Si no, mantiene la lógica original: solo completa grupos donde no existe pick.
